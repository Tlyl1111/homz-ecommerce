...
const kColorPrimary = Color(0xFF325052);
const kColorPrimaryLight = Color(0xFF849697);
const kColorBackground = Color(0xFFF6F6F6);
const kColorText = Color(0xFF0E1415);
...
const kOrderSuccess = "Order Success";
const kShippingAddress = "Shipping Address";
